...
export default function StreamPage() {
    ...
    return (
        <div className="flex h-screen relative">
            ...
            {modal && (
                <div className="fixed inset-y-0 right-0 w-full sm:w-64 bg-white border-l shadow-lg flex flex-col z-50 transition-transform duration-300 ease-in-out">
                    ...
                    <div className="flex flex-col flex-grow overflow-y-auto p-4 gap-3">
                        {['video1', 'video2', 'video3', 'video4', 'video5'].map((number) => (
